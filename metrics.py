...
def get_chunks(seq, tags):
    ...
    chunks = []
    chunk_type, chunk_start, chunk_attr = None, None, None
    for i, tok in enumerate(seq):
        # End of a chunk 1
        if tok == default1 and chunk_type is not None:
            # Add a chunk.
            chunk = (chunk_type, chunk_start, i, chunk_attr)
            chunks.append(chunk)
            chunk_type, chunk_start, chunk_attr = None, None, None
        ...
        # End of a chunk + start of a chunk!
            ...
            if len(res) == 1:
                continue
            tok_chunk_class, ht, tok_attr = res
            tok_chunk_type = ht
            if chunk_type is None:
                chunk_type, chunk_start, chunk_attr = tok_chunk_type, i, tok_attr
    ...
    if chunk_type is not None:
        chunk = (chunk_type, chunk_start, len(seq), chunk_attr)
        chunks.append(chunk)
